...
var G__5568 = null;
var G__5568__2 = (function (self__,k){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k);
});
var G__5568__3 = (function (self__,k,not_found){var self____$1 = this;var this$ = self____$1;return cljs.core._lookup.call(null,this$,k,not_found);
});
...
;
jQuery.prototype.apply = (function (self__,args5567){return self__.call.apply(self__,[self__].concat(args5567.slice()));
});
...
var hide__delegate = function ($elem,p__5569){var vec__5571 = p__5569;var speed = cljs.core.nth.call(null,vec__5571,0,null);var on_finish = cljs.core.nth.call(null,vec__5571,1,null);return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__5569 = null;if (arguments.length > 1) {
  p__5569 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return hide__delegate.call(this,$elem,p__5569);};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__5572){
var $elem = cljs.core.first(arglist__5572);
var p__5569 = cljs.core.rest(arglist__5572);
return hide__delegate($elem,p__5569);
});
...
var show__delegate = function ($elem,p__5573){var vec__5575 = p__5573;var speed = cljs.core.nth.call(null,vec__5575,0,null);var on_finish = cljs.core.nth.call(null,vec__5575,1,null);return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__5573 = null;if (arguments.length > 1) {
  p__5573 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return show__delegate.call(this,$elem,p__5573);};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__5576){
var $elem = cljs.core.first(arglist__5576);
var p__5573 = cljs.core.rest(arglist__5576);
return show__delegate($elem,p__5573);
});
...
var toggle__delegate = function ($elem,p__5577){var vec__5579 = p__5577;var speed = cljs.core.nth.call(null,vec__5579,0,null);var on_finish = cljs.core.nth.call(null,vec__5579,1,null);return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__5577 = null;if (arguments.length > 1) {
  p__5577 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return toggle__delegate.call(this,$elem,p__5577);};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__5580){
var $elem = cljs.core.first(arglist__5580);
var p__5577 = cljs.core.rest(arglist__5580);
return toggle__delegate($elem,p__5577);
});
...
var fade_out__delegate = function ($elem,p__5581){var vec__5583 = p__5581;var speed = cljs.core.nth.call(null,vec__5583,0,null);var on_finish = cljs.core.nth.call(null,vec__5583,1,null);return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__5581 = null;if (arguments.length > 1) {
  p__5581 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_out__delegate.call(this,$elem,p__5581);};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__5584){
var $elem = cljs.core.first(arglist__5584);
var p__5581 = cljs.core.rest(arglist__5584);
return fade_out__delegate($elem,p__5581);
});
...
var fade_in__delegate = function ($elem,p__5585){var vec__5587 = p__5585;var speed = cljs.core.nth.call(null,vec__5587,0,null);var on_finish = cljs.core.nth.call(null,vec__5587,1,null);return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__5585 = null;if (arguments.length > 1) {
  p__5585 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return fade_in__delegate.call(this,$elem,p__5585);};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__5588){
var $elem = cljs.core.first(arglist__5588);
var p__5585 = cljs.core.rest(arglist__5588);
return fade_in__delegate($elem,p__5585);
});
...
var slide_up__delegate = function ($elem,p__5589){var vec__5591 = p__5589;var speed = cljs.core.nth.call(null,vec__5591,0,null);var on_finish = cljs.core.nth.call(null,vec__5591,1,null);return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__5589 = null;if (arguments.length > 1) {
  p__5589 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_up__delegate.call(this,$elem,p__5589);};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__5592){
var $elem = cljs.core.first(arglist__5592);
var p__5589 = cljs.core.rest(arglist__5592);
return slide_up__delegate($elem,p__5589);
});
...
var slide_down__delegate = function ($elem,p__5593){var vec__5595 = p__5593;var speed = cljs.core.nth.call(null,vec__5595,0,null);var on_finish = cljs.core.nth.call(null,vec__5595,1,null);return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__5593 = null;if (arguments.length > 1) {
  p__5593 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return slide_down__delegate.call(this,$elem,p__5593);};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__5596){
var $elem = cljs.core.first(arglist__5596);
var p__5593 = cljs.core.rest(arglist__5596);
return slide_down__delegate($elem,p__5593);
});
...
var closest__delegate = function ($elem,selector,p__5597){var vec__5599 = p__5597;var context = cljs.core.nth.call(null,vec__5599,0,null);return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__5597 = null;if (arguments.length > 2) {
  p__5597 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return closest__delegate.call(this,$elem,selector,p__5597);};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__5600){
var $elem = cljs.core.first(arglist__5600);
arglist__5600 = cljs.core.next(arglist__5600);
var selector = cljs.core.first(arglist__5600);
var p__5597 = cljs.core.rest(arglist__5600);
return closest__delegate($elem,selector,p__5597);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__5603){var map__5605 = p__5603;var map__5605__$1 = ((cljs.core.seq_QMARK_.call(null,map__5605))?cljs.core.apply.call(null,cljs.core.hash_map,map__5605):map__5605);var request = map__5605__$1;var contentType = cljs.core.get.call(null,map__5605__$1,new cljs.core.Keyword(null,"contentType","contentType",624772805));var data = cljs.core.get.call(null,map__5605__$1,new cljs.core.Keyword(null,"data","data",1016980252));var ct = jayq.core.__GT_content_type.call(null,contentType);return (function (p1__5602_SHARP_){if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__5602_SHARP_,new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.pr_str.call(null,data));
} else
{return p1__5602_SHARP_;
}
}).call(null,(function (p1__5601_SHARP_){if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__5601_SHARP_,new cljs.core.Keyword(null,"contentType","contentType",624772805),ct);
} else
{return p1__5601_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__5606,content,callback){var vec__5608 = p__5606;var method = cljs.core.nth.call(null,vec__5608,0,null);var uri = cljs.core.nth.call(null,vec__5608,1,null);var params = cljs.core.clj__GT_js.call(null,cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"type","type",1017479852),clojure.string.upper_case.call(null,cljs.core.name.call(null,method)),new cljs.core.Keyword(null,"data","data",1016980252),cljs.core.clj__GT_js.call(null,content),new cljs.core.Keyword(null,"success","success",3441701749),callback], true));return jQuery.ajax(uri,params);
});
/**
...
var unbind__delegate = function ($elem,ev,p__5609){var vec__5611 = p__5609;var func = cljs.core.nth.call(null,vec__5611,0,null);return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__5609 = null;if (arguments.length > 2) {
  p__5609 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return unbind__delegate.call(this,$elem,ev,p__5609);};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__5612){
var $elem = cljs.core.first(arglist__5612);
arglist__5612 = cljs.core.next(arglist__5612);
var ev = cljs.core.first(arglist__5612);
var p__5609 = cljs.core.rest(arglist__5612);
return unbind__delegate($elem,ev,p__5609);
});
...
var on__delegate = function ($elem,events,p__5613){var vec__5615 = p__5613;var sel = cljs.core.nth.call(null,vec__5615,0,null);var data = cljs.core.nth.call(null,vec__5615,1,null);var handler = cljs.core.nth.call(null,vec__5615,2,null);return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__5613 = null;if (arguments.length > 2) {
  p__5613 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return on__delegate.call(this,$elem,events,p__5613);};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__5616){
var $elem = cljs.core.first(arglist__5616);
arglist__5616 = cljs.core.next(arglist__5616);
var events = cljs.core.first(arglist__5616);
var p__5613 = cljs.core.rest(arglist__5616);
return on__delegate($elem,events,p__5613);
});
...
var one__delegate = function ($elem,events,p__5617){var vec__5619 = p__5617;var sel = cljs.core.nth.call(null,vec__5619,0,null);var data = cljs.core.nth.call(null,vec__5619,1,null);var handler = cljs.core.nth.call(null,vec__5619,2,null);return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__5617 = null;if (arguments.length > 2) {
  p__5617 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return one__delegate.call(this,$elem,events,p__5617);};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__5620){
var $elem = cljs.core.first(arglist__5620);
arglist__5620 = cljs.core.next(arglist__5620);
var events = cljs.core.first(arglist__5620);
var p__5617 = cljs.core.rest(arglist__5620);
return one__delegate($elem,events,p__5617);
});
...
var off__delegate = function ($elem,events,p__5621){var vec__5623 = p__5621;var sel = cljs.core.nth.call(null,vec__5623,0,null);var handler = cljs.core.nth.call(null,vec__5623,1,null);return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__5621 = null;if (arguments.length > 2) {
  p__5621 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);} 
return off__delegate.call(this,$elem,events,p__5621);};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__5624){
var $elem = cljs.core.first(arglist__5624);
arglist__5624 = cljs.core.next(arglist__5624);
var events = cljs.core.first(arglist__5624);
var p__5621 = cljs.core.rest(arglist__5624);
return off__delegate($elem,events,p__5621);
});
...
done.cljs$lang$applyTo = (function (arglist__5625){
var deferred = cljs.core.first(arglist__5625);
var fns_args = cljs.core.rest(arglist__5625);
...
fail.cljs$lang$applyTo = (function (arglist__5626){
var deferred = cljs.core.first(arglist__5626);
var fns_args = cljs.core.rest(arglist__5626);
...
always.cljs$lang$applyTo = (function (arglist__5627){
var deferred = cljs.core.first(arglist__5627);
var fns_args = cljs.core.rest(arglist__5627);
